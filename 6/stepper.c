...
central2d_t* _Cilk_shared central2d_init(float w, float h, int nx, int ny,
...
void _Cilk_shared central2d_free(central2d_t* sim)
{
    free(sim->u);
    free(sim);
}
...
int _Cilk_shared central2d_offset(central2d_t* sim, int k, int ix, int iy)
{
...
static inline
void _Cilk_shared copy_subgrid(float* restrict dst,
...
void _Cilk_shared central2d_periodic(float* restrict u,
...
static inline
float _Cilk_shared xmin2s(float s, float a, float b) {
...
static inline
float _Cilk_shared limdiff(float um, float u0, float up) {
...
static inline
void _Cilk_shared limited_deriv1(float* restrict du,
...
static inline
void _Cilk_shared limited_derivk(float* restrict du,
                    const float* restrict u,
...
// Predictor half-step
static
void _Cilk_shared central2d_predict(float* restrict v,
...
// Corrector
static
void _Cilk_shared central2d_correct_sd(float* restrict s,
                          float* restrict d,
...
// Corrector
static
void _Cilk_shared central2d_correct(float* restrict v,
                       float* restrict scratch,
                       const float* restrict u,
                       const float* restrict f,
                       const float* restrict g,
...
static
void _Cilk_shared central2d_step(float* restrict u, float* restrict v,
                    float* restrict scratch,
                    float* restrict f,
                    float* restrict g,
...
static
int _Cilk_offload central2d_xrun(float* restrict u, float* restrict v,
                   float* restrict scratch,
                   float* restrict f,
                   float* restrict g,
...
int _Cilk_shared central2d_run(central2d_t* sim, float tfinal, int nthread, int nbatch)
{
