...
static
void _Cilk_shared shallow2dv_flux(float* restrict fh,
                     float* restrict fhu,
                     float* restrict fhv,
                     float* restrict gh,
                     float* restrict ghu,
...
static
void _Cilk_shared shallow2dv_speed(float* restrict cxy,
                      const float* restrict h,
                      const float* restrict hu,
                      const float* restrict hv,
                      float g,
...
void _Cilk_shared shallow2d_flux(float* FU, float* GU, const float* U,
...
void _Cilk_shared shallow2d_speed(float* cxy, const float* U,
                     int ncell, int field_stride)
{
